 ...
 * </p>
 * <ul>
 *   <li>{@link smart_nursing_home.impl.HeaterImpl#isOn <em>On</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HeaterImpl extends ClazzImpl implements Heater {
	...
	protected EClass eStaticClass() {
		return Smart_nursing_homePackage.Literals.HEATER;
	}
	...
	public void setOn(boolean newOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Smart_nursing_homePackage.HEATER__ON, oldOn, on));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Smart_nursing_homePackage.HEATER__ON:
				return isOn();
		}
