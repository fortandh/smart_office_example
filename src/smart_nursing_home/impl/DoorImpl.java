 ...
 * </p>
 * <ul>
 *   <li>{@link smart_nursing_home.impl.DoorImpl#getRoom <em>Room</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DoorImpl extends ClazzImpl implements Door {
	...
	protected EClass eStaticClass() {
		return Smart_nursing_homePackage.Literals.DOOR;
	}
	...
	public EList<Room> getRoom() {
		if (room == null) {
			room = new EObjectWithInverseResolvingEList.ManyInverse<Room>(Room.class, this, Smart_nursing_homePackage.DOOR__ROOM, Smart_nursing_homePackage.ROOM__DOOR);
		}
		return room;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Smart_nursing_homePackage.DOOR__ROOM:
