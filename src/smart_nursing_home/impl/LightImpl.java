 ...
 * </p>
 * <ul>
 *   <li>{@link smart_nursing_home.impl.LightImpl#isOn <em>On</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LightImpl extends ClazzImpl implements Light {
	/**
	...
	protected EClass eStaticClass() {
		return Smart_nursing_homePackage.Literals.LIGHT;
	}
	...
	public void setOn(boolean newOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Smart_nursing_homePackage.LIGHT__ON, oldOn, on));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Smart_nursing_homePackage.LIGHT__ON:
				return isOn();
		}
