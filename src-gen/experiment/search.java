...
public class search {
  ...
  protected final int populationSize = 10000;
  
  protected final int maxEvaluations = 1000000;
  ...
  protected ProgressListener _createListener_0() {
    CollectiveProgressListener _collectiveProgressListener = new CollectiveProgressListener();
    return _collectiveProgressListener;
  }
